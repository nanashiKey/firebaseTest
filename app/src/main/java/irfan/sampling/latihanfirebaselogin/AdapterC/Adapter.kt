...
class Adapter(val mCtx: Context, val layoutResId: Int,
    ...
    override fun getView(position: Int, convertView: View?
        ...
        val textNama = view
            .findViewById<TextView>(R.id.textNama)
        val textStatus = view
            .findViewById<TextView>(R.id.textStatus)

        val textUpdate = view
            .findViewById<TextView>(R.id.TextUpdate)
        val textDelete = view
            .findViewById<TextView>(R.id.TextDelete)
    ...
    private fun showUpdateDialog(user: Users) {
        ...
        val view = inflater.inflate(R.layout.update_data,
            null)
        val textNama = view.findViewById<EditText>(
            R.id.inputNama)
        val textStatus = view.findViewById<EditText>(
            R.id.inputStatus)
